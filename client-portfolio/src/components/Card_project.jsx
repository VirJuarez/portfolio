...
return english?(
    <div className=" flex flex-col mx-4 mb-8 h-[550px]">
    ...
    <div className="grid xl:grid-cols-3 xl:gap-x-4">
        <div className="grid col-span-2">
            <img src={props.imagen} alt="imagen" className="flex justify-center w-[650px] rounded-xl"></img>
            <div className="py-1 my-4 flex justify-around">
            <a href={props.deploy}
            className=" h-fit rounded-full  bg-teal-700 border-teal-400 border-solid border-2 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-amber-400 hover:border-amber-400"
            >Go to CAMPY</a>
            <a href={props.repofront}
            className=" h-fit rounded-full  bg-teal-700 border-teal-400 border-solid border-2 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-amber-400 hover:border-amber-400"
            >Repository FRONT</a>
            <a href={props.repoback}
            className=" h-fit rounded-full  bg-teal-700 border-teal-400 border-solid border-2 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-amber-400 hover:border-amber-400"
            >Repository BACK</a>
            </div>   
        </div>
        <div>
