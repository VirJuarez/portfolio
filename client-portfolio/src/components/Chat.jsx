...
export default function Chat (){
    ...
    const rtas={
        ...
        contacto:(<p>Actualmente estoy buscando mi primer trabajo en IT. Puedes descargar mi CV <a className="underline" href="./CV JUAREZ_MV_2024" download="CV_JUAREZ_MV.pdf">AQUÍ</a>. También puedes contactarme directamente por <a className="underline" target="_blank" href="mailto:virginia.juarez1996@gmail.com">Mail</a>, <a className="underline" href="https://walink.co/855b8f" target="_blank">WhatApp</a> o <a className="underline" target="_blank" href="https://www.linkedin.com/in/maria-virginia-juarez/">LinkedIn</a></p>),
